  ...
  return (
    <div className='wlcm-container'>
      ...
      <div className='login-section'>
        <div className='login-section__heading'>
          Want to Volunteer Us ? 
        </div>
        <div className='button-section'>
          <button id='login__register-section__button'>Sign Up</button>
          <button id="login-section__button">Log In</button>
        </div>
      </div>
    </div>
  )
